...
public class MammogramClassification {//was Animals
    protected static final Logger log = LoggerFactory.getLogger(MammogramClassification.class);
    ...
    protected static int epochs = 0;
    protected static double splitTrainTest = 0.8;
    protected static boolean save = true;
	protected static double maxAccuracy = 0.0;

    protected static String modelType = "LeNet"; // LeNet, AlexNet or Custom but you need to fill it out
    private int numLabels;
    private String MAMMO_TRAIN_PATH = " ";
    private String MAMMO_TEST_PATH = " ";
    ...
    public void run(String[] args) throws Exception {
         ...
         **/
            ...
            System.out.println("Usage: #_of_epochs pathToTrainData pathToTestData pathToModel");
            System.exit(0);
        ...
        //File mainPath = new File("/home/group7/mammograms/small/"); 
		    File trainPath = new File(MAMMO_TRAIN_PATH); //"/home/group7/mammograms/small/"
		    File testPath = new File(MAMMO_TEST_PATH); //"/home/group7/mammograms/small/"
        
        FileSplit fileSplitTrain = new FileSplit(trainPath, NativeImageLoader.ALLOWED_FORMATS, rng);
        int numExamplesTrain = toIntExact(fileSplitTrain.length());
        numLabels = fileSplitTrain.getRootDir().listFiles(File::isDirectory).length; //This only works if your root is clean: only label subdirs.
        BalancedPathFilter pathFilterTrain = new BalancedPathFilter(rng, labelMaker, numExamplesTrain, numLabels, batchSize);
		
		    FileSplit fileSplitTest = new FileSplit(testPath, NativeImageLoader.ALLOWED_FORMATS, rng);
        int numExamplesTest = toIntExact(fileSplitTest.length());
        ...
        BalancedPathFilter pathFilterTest = new BalancedPathFilter(rng, labelMaker, numExamplesTest, numLabels, batchSize);

        /**
         * Data Setup -> train test split
         *  - inputSplit = define train and test split
         **/
        InputSplit[] inputSplitTrain = fileSplitTrain.sample(pathFilterTrain, 1,0);
        InputSplit trainData = inputSplitTrain[0];
		    InputSplit[] inputSplitTest = fileSplitTest.sample(pathFilterTest, 1,0);
        InputSplit testData = inputSplitTest[0];
        ...
        ImageTransform warpTransform1 = new WarpImageTransform(rng, 42);
        
        ImageTransform flipTransform3 = new FlipImageTransform(rng);
        ImageTransform flipTransform4 = new FlipImageTransform(new Random(321));
        ImageTransform warpTransform2 = new WarpImageTransform(rng, 24);
//        ImageTransform colorTransform = new ColorConversionTransform(new Random(seed), COLOR_BGR2YCrCb);
        List<ImageTransform> transforms = Arrays.asList(new ImageTransform[]{flipTransform1, warpTransform1, flipTransform2, flipTransform3, warpTransform2, flipTransform4});
...
//        network.setListeners(new StatsListener( statsStorage),new ScoreIterationListener(1));
    ...
    public static void main(String[] args) throws Exception {
        new MammogramClassification().run(args);
    }
